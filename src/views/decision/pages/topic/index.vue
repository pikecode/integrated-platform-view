<template>
  <basic-container>
    ...
    <div class="search-panel">
      ...
      <el-form :model="search" class="search-form" label-width="100px">
        <el-row :gutter="20">
      ...
      <el-row :gutter="10" class="batch-actions">
        <el-col :span="24">
          ...
          <el-button type="warning" @click="handleBatchApplyMeeting" :disabled="selectedTopics.length === 0">
            批量申请上会
          </el-button>
